/*
	...
	QUESTÃO 04: A função logarítmica é complementar à potenciação. 
	Ou seja, uma vez que 3^4 = 81, podemos então afirmar que log 3 81 = 4. 
	...
	calcule o valor de log a b. Nota: a sua solução deverá apresentar um valor inteiro que, 
