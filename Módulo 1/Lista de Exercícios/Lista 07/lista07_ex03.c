/*
	...
	Questão 03:
	Desenvolver um programa que leia dois números inteiros n1 e n2 e determine se n2 
	...
	Ao dividir um número por 10 sucessivamente, conseguiremos ter acesso a cada um de seus 
	algarismos, a partir da operação de resto da divisão.
	Então, para cada um dos algarismos do primeiro valor, o compararemos com todos os 
	algarismos do segundo valor (sempre com sucessivas divisões por 10).
*/
